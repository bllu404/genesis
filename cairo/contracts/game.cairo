...
@view
func get_block_balance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    user : felt, block_type : felt
) -> (num_blocks : felt):
...
}(x : felt, y : felt, z : felt, user : felt, block_type : felt) -> (block_type : felt):
...
func _place_block{
    syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr, bitwise_ptr : BitwiseBuiltin*
}(x : felt, y : felt, z : felt, user : felt, block_type : felt):
    alloc_locals
...
func mine_block{
...
}(x : felt, y : felt, z : felt) -> (block_type : felt):
    alloc_locals
    ...
    # Mine the block
    let (mined_block_type) = _mine_block(x=x, y=y, z=z, user=user, block_type=block_state)
...
func read_state{
    syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr, bitwise_ptr : BitwiseBuiltin*
}(x : felt, y : felt, z : felt) -> (block_state : felt):
    alloc_locals
